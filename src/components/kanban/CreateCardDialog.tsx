...
export function CreateCardDialog({ open, onOpenChange, onCreateCard, availableTags, onCreateTag }: CreateCardDialogProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="card-value" className="flex items-center gap-1">
            ...
            <div>
              <Label htmlFor="card-phone" className="flex items-center gap-1">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="card-date" className="flex items-center gap-1">
          ...
          <div>
            <Label htmlFor="card-responsible" className="flex items-center gap-1">
